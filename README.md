Nginx HMAC Secure Link Module which accepts Unix timestamps
--
...
For improved security the timestamp in the format 2017-12-08T07:54:59+00:00 (one possibility according to ISO 8601) or as Unix timestamp should be appended to the message to be hashed.
